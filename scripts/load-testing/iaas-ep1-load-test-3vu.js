/**
 * Load Test: IaaS Admin Endpoint EP1 - 3 VUs (for FaaS comparison)
...
// Load test configuration for 3 VUs (matching FaaS test setup)
...
export function handleSummary(data) {
  ...
  console.log('\n' + '='.repeat(80));
  console.log('📊 IaaS EP1 Load Test Results Summary (3 VUs)');
  ...
  console.log(`VUs: 3 (for FaaS comparison)`);
  console.log('-'.repeat(80));
