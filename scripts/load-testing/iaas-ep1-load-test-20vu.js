/**
 * Load Test: IaaS Admin Endpoint EP1 - 20 VUs
 * GET /admin/store/{storeId}
 *
 * Purpose: Measure IaaS performance at higher load for FaaS vs IaaS comparison
...
// Load test configuration for 20 VUs
...
export function handleSummary(data) {
  ...
  console.log('\n' + '='.repeat(80));
  console.log('📊 IaaS EP1 Load Test Results Summary (20 VUs)');
